        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5 flex-1">
              <Link
                to="/"
                className="relative w-11 h-11 bg-glovo-purple rounded-2xl flex items-center justify-center shrink-0 shadow-lg shadow-glovo-purple/30 hover:scale-105 transition-transform focus-ring"
              ...
              <div className="hidden sm:flex flex-col leading-none">
                <Link to="/" className="font-extrabold text-lg text-glovo-purple tracking-tight">
                  Fresh N'Good
                </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <motion.button
                ...
                className="relative w-10 h-10 flex items-center justify-center rounded-full bg-glovo-purple text-white shadow-lg shadow-glovo-purple/25 hover:shadow-xl hover:shadow-glovo-purple/35 transition-shadow"
                whileTap={{ scale: 0.95 }}
              >
